    ...
    <nav class="navbar">
        <div class="dropdown">
            ...
            <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="dasboard/tambah.php">Tambah Kendaraan</a></li>
                <li><a class="dropdown-item" href="dasboard/info/data.php">Catatan</a></li>
                <li><a class="dropdown-item" href="dasboard/tampil.php#">Data Kendaraan</a></li>
            </ul>
        </div>
        <div class="btn-group">
