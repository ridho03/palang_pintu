...
<body>
    ...
    <div>
        ...
        <table>
            ...
            $query_run = mysqli_query($conn, "SELECT * FROM shop");
            ...
            while ($row = mysqli_fetch_array($query_run)) {
                ...
                echo "<td>" . $row['id'] . "</td>";
                echo "<td>" . $row['nama'] . "</td>";
                echo "<td>" . $row['karbon'] . "</td>";
                echo "<td>";
                echo "<a href='beli.php' class='btn btn-info'>Beli</a>";
                echo "</td>";
                echo "</tr>";
            }
            ?>
        </table>
        <button type="button" class="btn btn-success" style="margin: 20px; float: right;"
            onclick="window.location.href='jual.php?uid=<?php echo $uid; ?>';">Jual</button>
        <button type="button" class="btn btn-secondary btn-lg" style="margin: 12px;"
            onclick="window.location.href='../dasboard/admin/index.php';">Back</button>
    </div>
